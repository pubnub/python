...
# pnconfig.subscribe_key = os.getenv('SUB_KEY')  "sub-c-13642e4a-f6c2-11eb-b0bd-22908b043f7e"
# pnconfig.subscribe_key = "sub-c-645d1439-e412-4123-be12-265bda8711a5"
# pnconfig.publish_key = "pub-c-7741d8b8-66db-4b25-9192-d7781b158082"
# pnconfig.user_id = "my_uuid"
# pnconfig.secret_key = "sec-c-OWY0NjUxYzctYWVjNy00MTc1LTk1NTMtNjI3ZTBkYmJiZDI4"
# pnconfig.origin = "ingress-tcp-pub.pdx1.aws.int.ps.pn"
# pnconfig.ssl = False
# pnconfig.non_subscribe_request_
...
create_space = pubnub.create_space(
    ...
    type="0906personal-test",
    status="0906in-testing",
    sync=True
)
