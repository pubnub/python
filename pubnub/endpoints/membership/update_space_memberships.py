...
from pubnub.models.consumer.membership import PNUpdateSpaceMembershipsResult
from pubnub.enums import HttpMethod, PNOperationType
from pubnub.exceptions import PubNubException


class UpdateSpaceMemberships(Endpoint):
    UPDATE_SPACE_MEMBERSHIPS_PATH = '/v1/objects/%s/users/%s/spaces'
    MAX_LIMIT = 100
    ...
    def __init__(self, pubnub):
        ...
        self._start = None
        self._end = None
        self._limit = UpdateSpaceMemberships.MAX_LIMIT
        self._count = False
        self._include = None
        self._user_id = None
        self._data = None
    ...
    def custom_params(self):
        ...
        if self._limit != UpdateSpaceMemberships.MAX_LIMIT:
    ...
    def build_path(self):
        ...
        return UpdateSpaceMemberships.UPDATE_SPACE_MEMBERSHIPS_PATH % (self.pubnub.config.subscribe_key, self._user_id)
    ...
    def create_response(self, envelope):   # pylint: disable=W0221
        return PNUpdateSpaceMembershipsResult(envelope)
    ...
    def operation_type(self):
        return PNOperationType.PNUpdateSpaceMembershipsOperation
