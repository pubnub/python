...
class HeartbeatingState(PNState):
    def __init__(self, context: PNContext) -> None:
        super().__init__(context)
        self._transitions = {
            events.HeartbeatSuccessEvent.__name__: self.cooldown,
    ...
    def on_enter(self, context: Union[None, PNContext]):
        self._context.update(context)
        super().on_enter(self._context)
        return effects.HeartbeatEffect()

    def cooldown(self, event: events.HeartbeatSuccessEvent, context: PNContext) -> PNTransition:
        self._context.update(context)
...
class HeartbeatCooldownState(PNState):
    ...
    def on_enter(self, context: PNContext | None):
        self._context.update(context)
        super().on_enter(self._context)
