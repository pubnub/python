...
class TestAddChannelsToPush(unittest.TestCase):
    """Unit tests for the add_channels_to_push method in PubNub core."""

    def test_add_channels_to_push_with_named_parameters(self):
        """Test add_channels_to_push with named parameters."""
        ...
        self.assertIsInstance(endpoint, AddChannelsToPush)
    ...
    def test_add_channels_to_push_builder_gcm(self):
    ...
    def test_add_channels_to_push_builder_fcm(self):
        """Test that the returned object supports method chaining."""
        pubnub = PubNub(mocked_config)
    ...
    def test_add_channels_to_push_apns2_fails_without_topic(self):
    ...
    def test_add_channels_to_push_none_push_type_validation(self):
    ...
    def test_add_channels_to_push_none_device_id_validation(self):
    ...
    def test_add_channels_to_push_none_channels_validation(self):
