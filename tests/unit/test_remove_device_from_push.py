...
class TestRemoveDeviceFromPush(unittest.TestCase):
    """Unit tests for the remove_device_from_push method in PubNub core."""

    def test_remove_device_from_push_with_named_parameters(self):
        """Test remove_device_from_push with named parameters."""
    ...
    def test_remove_device_from_push_builder(self):
    ...
    def test_remove_device_from_push_none_push_type_validation(self):
    ...
    def test_remove_device_from_push_none_device_id_validation(self):
