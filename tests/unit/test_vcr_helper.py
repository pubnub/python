...
class TestVCRMatchers(unittest.TestCase):
    ...
    def test_string_list_in_path_query_matcher(self):
        r1 = Request(
            query=[('channel', 'test-pam-asyncio-ch1,test-pam-asyncio-ch2'), ('pnsdk', 'PubNub-Python-Asyncio/4.0.2'),
                   ('r', '1'), ('uuid', 'test-pam-asyncio-uuid'), ('w', '1')])
        r2 = Request(
            query=[('channel', 'test-pam-asyncio-ch2,test-pam-asyncio-ch1'), ('pnsdk', 'PubNub-Python-Asyncio/4.0.2'),
                   ('r', '1'), ('uuid', 'test-pam-asyncio-uuid'), ('w', '1')])
