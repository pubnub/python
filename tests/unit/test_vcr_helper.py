...
class TestVCRMatchers(unittest.TestCase):
    def test_string_list_in_path_matcher(self):
        ...
        r4 = Request('/v2/subscribe/sub-c-33f55052-190b-11e6-bfbc-02ee2ddab7fe/test-here-now-asyncio-ch2,test-here-now-asyncio-ch1/0')
        r5 = Request('/v2/subscribe/sub-c-33f55052-190b-11e6-bfbc-02ee2ddab7fe/test-here-now-asyncio-ch1,test-here-now-asyncio-ch2/0')
    ...
    def test_string_list_in_path_query_matcher(self):
        r1 = Request(query=[('channel', 'test-pam-asyncio-ch1,test-pam-asyncio-ch2'), ('pnsdk', 'PubNub-Python-Asyncio/4.0.0'), ('r', '1'), ('uuid', 'test-pam-asyncio-uuid'), ('w', '1')])
        r2 = Request(query=[('channel', 'test-pam-asyncio-ch2,test-pam-asyncio-ch1'), ('pnsdk', 'PubNub-Python-Asyncio/4.0.0'), ('r', '1'), ('uuid', 'test-pam-asyncio-uuid'), ('w', '1')])
